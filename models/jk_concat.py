...
class JK_CONCAT(JK_GCN):

    def __init__(self, placeholder, input_dim, depth, **kwargs):
        self.depth = depth
        self.shortcuts = []
        super(JK_CONCAT, self).__init__(placeholder, input_dim, **kwargs)
    ...
    def build(self):
        ...
        self.outputs = tf.concat([self.activations[1], self.activations[2], self.activations[3], self.activations[4]], 1)
    ...
    def _build(self):
        ...
        self.layers.append(GraphConvolution(input_dim=4 * FLAGS.hidden1,
                                            output_dim=self.output_dim,
                                            placeholders=self.placeholder,
                                            act=lambda x: x,
                                            dropout=True,
